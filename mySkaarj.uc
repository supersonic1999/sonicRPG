class mySkaarj extends INVMonster;
...
{
    if(ROLE == ROLE_Authority && Controller.Target != none && MeleeDamageTarget(20, (30000 * Normal(Controller.Target.Location - Location))))
		PlaySound(sound'clawhit1s', SLOT_Interact);
}

function ClawDamageTarget()
{
	if(ROLE == ROLE_Authority && Controller.Target != none && MeleeDamageTarget(25, (25000 * Normal(Controller.Target.Location - Location))))
		PlaySound(sound'clawhit1s', SLOT_Interact);
}
...
defaultproperties
{
     Footstep(0)=Sound'SatoreMonsterPackv120.Nali.walkC'
     Footstep(1)=Sound'SatoreMonsterPackv120.Nali.walkC'
     DeathAnim(0)="Death"
     DeathAnim(1)="Death2"
     DeathAnim(2)="Death3"
     DeathAnim(3)="Death4"
